...
import type { FoundUsers, PageBeanUser, PageBeanUserKey, User } from "../types/index.ts";
 ...
 *
 * @param params.query - A query string that is matched against user attributes, such as `displayName` and `emailAddress`, to find relevant users. The string can match the prefix of the attribute's value. For example, *query=john* matches a user with a `displayName` of *John Smith* and a user with an `emailAddress` of *johnson@example.com*. Required, unless `accountId` is specified.
 ...
 * @param params.accountId - A query string that is matched exactly against user `accountId`. Required, unless `query` is specified.
 * @param params.projectKeys - A list of project keys (case sensitive). This parameter accepts a comma-separated list.
 ...
 */
export function findBulkAssignableUsers(
  ctx: ClientContext,
  params: {
    /**
  ...
  const { query, username, accountId, projectKeys, startAt, maxResults } = params;
  return ctx.request({
    method: "get",
    path: "/rest/api/3/user/assignable/multiProjectSearch",
    query: { query, username, accountId, projectKeys, startAt, maxResults },
 ...
 *
 * @param params.query - A query string that is matched against user attributes, such as `displayName`, and `emailAddress`, to find relevant users. The string can match the prefix of the attribute's value. For example, *query=john* matches a user with a `displayName` of *John Smith* and a user with an `emailAddress` of *johnson@example.com*. Required, unless `username` or `accountId` is specified.
 * @param params.sessionId - The sessionId of this request. SessionId is the same until the assignee is set.
 * @param params.username - This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @param params.accountId - A query string that is matched exactly against user `accountId`. Required, unless `query` is specified.
 * @param params.project - The project ID or project key (case sensitive). Required, unless `issueKey` or `issueId` is specified.
 * @param params.issueKey - The key of the issue. Required, unless `issueId` or `project` is specified.
 * @param params.issueId - The ID of the issue. Required, unless `issueKey` or `project` is specified.
 * @param params.startAt - The index of the first item to return in a page of results (page offset).
 * @param params.maxResults - The maximum number of items to return. This operation may return less than the maximum number of items even if more are available. The operation fetches users up to the maximum and then, from the fetched users, returns only the users that can be assigned to the issue.
 * @param params.actionDescriptorId - The ID of the transition.
 * @returns Returned if the request is successful.
 */
export function findAssignableUsers(
  ctx: ClientContext,
  params?: {
    /**
 ...
 * @param params.username - This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @param params.accountId - A query string that is matched exactly against user `accountId`. Required, unless `query` is specified.
 * @param params.permissions - A comma separated list of permissions. Permissions can be specified as any: *  permission returned by [Get all permissions](#api-rest-api-3-permissions-get). *  custom project permission added by Connect apps. *  (deprecated) one of the following: *  ASSIGNABLE\_USER *  ASSIGN\_ISSUE *  ATTACHMENT\_DELETE\_ALL *  ATTACHMENT\_DELETE\_OWN *  BROWSE *  CLOSE\_ISSUE *  COMMENT\_DELETE\_ALL *  COMMENT\_DELETE\_OWN *  COMMENT\_EDIT\_ALL *  COMMENT\_EDIT\_OWN *  COMMENT\_ISSUE *  CREATE\_ATTACHMENT *  CREATE\_ISSUE *  DELETE\_ISSUE *  EDIT\_ISSUE *  LINK\_ISSUE *  MANAGE\_WATCHER\_LIST *  MODIFY\_REPORTER *  MOVE\_ISSUE *  PROJECT\_ADMIN *  RESOLVE\_ISSUE *  SCHEDULE\_ISSUE *  SET\_ISSUE\_SECURITY *  TRANSITION\_ISSUE *  VIEW\_VERSION\_CONTROL *  VIEW\_VOTERS\_AND\_WATCHERS *  VIEW\_WORKFLOW\_READONLY *  WORKLOG\_DELETE\_ALL *  WORKLOG\_DELETE\_OWN *  WORKLOG\_EDIT\_ALL *  WORKLOG\_EDIT\_OWN *  WORK\_ISSUE
 * @param params.issueKey - The issue key for the issue.
 * @param params.projectKey - The project key for the project (case sensitive).
 * @param params.startAt - The index of the first item to return in a page of results (page offset).
 * @param params.maxResults - The maximum number of items to return per page.
 * @returns Returned if the request is successful.
 */
export function findUsersWithAllPermissions(
  ctx: ClientContext,
  params: {
    /**
     * A query string that is matched against user attributes, such as `displayName` and `emailAddress`, to find relevant users. The string can match the prefix of the attribute's value. For example, *query=john* matches a user with a `displayName` of *John Smith* and a user with an `emailAddress` of *johnson@example.com*. Required, unless `accountId` is specified.
  ...
  const { query, username, accountId, permissions, issueKey, projectKey, startAt, maxResults } =
    params;
  return ctx.request({
    method: "get",
    path: "/rest/api/3/user/permission/search",
    query: { query, username, accountId, permissions, issueKey, projectKey, startAt, maxResults },
    headers: options?.headers,
    signal: options?.signal,
    extensions: options?.extensions,
  });
 ...
 *
 * @param params.query - A query string that is matched against user attributes, such as `displayName`, and `emailAddress`, to find relevant users. The string can match the prefix of the attribute's value. For example, *query=john* matches a user with a `displayName` of *John Smith* and a user with an `emailAddress` of *johnson@example.com*.
 * @param params.maxResults - The maximum number of items to return. The total number of matched users is returned in `total`.
 * @param params.showAvatar - Include the URI to the user's avatar.
 * @param params.exclude - This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @param params.excludeAccountIds - A list of account IDs to exclude from the search results. This parameter accepts a comma-separated list. Multiple account IDs can also be provided using an ampersand-separated list. For example, `excludeAccountIds=5b10a2844c20165700ede21g,5b10a0effa615349cb016cd8&excludeAccountIds=5b10ac8d82e05b22cc7d4ef5`. Cannot be provided with `exclude`.
 * @returns Returned if the request is successful.
 */
export function findUsersForPicker(
  ctx: ClientContext,
  params: {
 ...
 *
 * @param params.query - A query string that is matched against user attributes ( `displayName`, and `emailAddress`) to find relevant users. The string can match the prefix of the attribute's value. For example, *query=john* matches a user with a `displayName` of *John Smith* and a user with an `emailAddress` of *johnson@example.com*. Required, unless `accountId` or `property` is specified.
 * @param params.accountId - A query string that is matched exactly against a user `accountId`. Required, unless `query` or `property` is specified.
 * @param params.startAt - The index of the first item to return in a page of filtered results (page offset).
 * @param params.maxResults - The maximum number of items to return per page.
 * @param params.property - A query string used to search properties. Property keys are specified by path, so property keys containing dot (.) or equals (=) characters cannot be used. The query string cannot be specified using a JSON object. Example: To search for the value of `nested` from `{"something":{"nested":1,"other":2}}` use `thepropertykey.something.nested=1`. Required, unless `accountId` or `query` is specified.
 * @returns Returned if the request is successful.
 */
export function findUsers(
  ...
  const { query, username, accountId, startAt, maxResults, property } = params ?? {};
  return ctx.request({
    method: "get",
    path: "/rest/api/3/user/search",
    query: { query, username, accountId, startAt, maxResults, property },
    headers: options?.headers,
    signal: options?.signal,
    extensions: options?.extensions,
  });
 ...
 * @returns Returned if the request is successful.
 */
export function findUsersByQuery(
  ctx: ClientContext,
  params: {
    /** The search query. */
    query: string;
  ...
  const { query, startAt, maxResults } = params;
  return ctx.request({
    method: "get",
 ...
 * @param params.query - The search query.
 * @param params.startAt - The index of the first item to return in a page of results (page offset).
 * @param params.maxResult - The maximum number of items to return per page.
 * @returns Returned if the request is successful.
 */
export function findUserKeysByQuery(
  ctx: ClientContext,
  params: {
    /** The search query. */
    query: string;
  ...
  const { query, startAt, maxResult } = params;
  return ctx.request({
    method: "get",
 ...
 * @param params.username - This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @param params.accountId - A query string that is matched exactly against user `accountId`. Required, unless `query` is specified.
 * @param params.issueKey - The issue key for the issue. Required, unless `projectKey` is specified.
 * @param params.projectKey - The project key for the project (case sensitive). Required, unless `issueKey` is specified.
 * @param params.startAt - The index of the first item to return in a page of results (page offset).
 * @param params.maxResults - The maximum number of items to return per page.
 * @returns Returned if the request is successful.
 */
export function findUsersWithBrowsePermission(
  ctx: ClientContext,
  params?: {
    /**
     * A query string that is matched against user attributes, such as `displayName` and `emailAddress`, to find relevant users. The string can match the prefix of the attribute's value. For example, *query=john* matches a user with a `displayName` of *John Smith* and a user with an `emailAddress` of *johnson@example.com*. Required, unless `accountId` is specified.
  ...
  const { query, username, accountId, issueKey, projectKey, startAt, maxResults } = params ?? {};
  return ctx.request({
    method: "get",
    path: "/rest/api/3/user/viewissue/search",
    query: { query, username, accountId, issueKey, projectKey, startAt, maxResults },
    headers: options?.headers,
    signal: options?.signal,
    extensions: options?.extensions,
  });
...
export function createUserSearchService(ctx: ClientContext) {
  return {
    /**
     * Find users assignable to projects
     *
    ...
    findBulkAssignableUsers(
      ...
      return findBulkAssignableUsers(ctx, params, options);
    },
    ...
    findAssignableUsers(
      ...
      return findAssignableUsers(ctx, params, options);
    },
    ...
    findUsersWithAllPermissions(
      ...
      return findUsersWithAllPermissions(ctx, params, options);
    },
    ...
    findUsersForPicker(
      ...
      return findUsersForPicker(ctx, params, options);
    },
    ...
    findUsers(
      ...
      return findUsers(ctx, params, options);
    },
    ...
    findUsersByQuery(
      ...
      return findUsersByQuery(ctx, params, options);
    },
    ...
    findUserKeysByQuery(
      ...
      return findUserKeysByQuery(ctx, params, options);
    },
    ...
    findUsersWithBrowsePermission(
      ...
      return findUsersWithBrowsePermission(ctx, params, options);
    },
  };
}
