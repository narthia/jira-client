 ...
 * @param params.id_path - The ID of the project role. Use [Get all project roles](#api-rest-api-3-role-get) to get a list of project role IDs.
 ...
 *
 * @param params.projectIdOrKey - The project ID or project key (case sensitive).
 * @param params.id - The ID of the project role. Use [Get all project roles](#api-rest-api-3-role-get) to get a list of project role IDs.
