...
import { createIssueBulkOperationsService } from "./services/issue-bulk-operations.ts";
 ...
 */
export function createPlatformV3Sdk(config: SdkConfig) {
  ...
  return {
     ...
     */
    issueBulkOperations: createIssueBulkOperationsService(ctx),
    /**
...
export type CreatePlatformV3SdkClient = ReturnType<typeof createPlatformV3Sdk>;
