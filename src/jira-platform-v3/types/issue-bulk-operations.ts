...
export interface BulkOperationProgress {
  ...
  failedAccessibleIssues?: Record<string, string[]>;
  /**
...
export interface IssueBulkMovePayload {
   ...
   */
  targetToSourcesMapping?: Record<string, TargetToSourcesMapping>;
}

export type IssueBulkOperationsFieldOption = Record<string, unknown>;
...
export type Fields2 = MandatoryFieldValue | MandatoryFieldValueForAdf;
