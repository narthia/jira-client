...
import { http as httpTransport } from "./_http.ts";

/** Auth accepted by `createSdk`. */
export interface CreateSdkAuthConfig {
  email: string;
  apiToken: string;
}

function toRuntimeAuth(auth: CreateSdkAuthConfig): AuthConfig {
