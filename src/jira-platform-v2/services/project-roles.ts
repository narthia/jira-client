 ...
 * @param params.excludeInactiveUsers - Exclude inactive users.
 * @returns Returned if the request is successful.
 */
export function getProjectRole(
  ...
  const { projectIdOrKey, id, excludeInactiveUsers } = params;
  return ctx.request({
    method: "get",
 ...
 *
 * @param params.projectIdOrKey - The project ID or project key (case sensitive).
 * @param params.currentMember - Whether the roles should be filtered to include only those the user is assigned to.
 * @param params.excludeOtherServiceRoles - Do not return the default JSM company-managed space from CSM spaces, or the default CSM roles from JSM spaces.
 * @returns Returned if the request is successful.
 */
export function getProjectRoleDetails(
  ctx: ClientContext,
  params: {
    /** The project ID or project key (case sensitive). */
    projectIdOrKey: string;
  ...
  const { projectIdOrKey, currentMember, excludeConnectAddons, excludeOtherServiceRoles } = params;
  return ctx.request({
    method: "get",
    path: "/rest/api/2/project/{projectIdOrKey}/roledetails",
    pathParams: { projectIdOrKey },
    query: { currentMember, excludeConnectAddons, excludeOtherServiceRoles },
    headers: options?.headers,
    signal: options?.signal,
    extensions: options?.extensions,
  });
...
export function createProjectRole(
  ctx: ClientContext,
  params: CreateUpdateRoleRequestBean,
  options?: {
    headers?: Record<string, string | number | boolean>;
    signal?: AbortSignal;
    extensions?: Record<string, unknown>;
 ...
 * @returns Returned if the request is successful.
 */
export function getProjectRoleById(
  ctx: ClientContext,
  params: {
    /**
     * The ID of the project role. Use [Get all project roles](#api-rest-api-2-role-get) to get a list of project role IDs.
 ...
 * @returns Returned if the request is successful.
 */
export function fullyUpdateProjectRole(
  ctx: ClientContext,
  params: CreateUpdateRoleRequestBean & {
    /**
     * The ID of the project role. Use [Get all project roles](#api-rest-api-2-role-get) to get a list of project role IDs.
 ...
 * @returns Returned if the request is successful.
 */
export function partialUpdateProjectRole(
  ctx: ClientContext,
  params: CreateUpdateRoleRequestBean & {
    /**
     * The ID of the project role. Use [Get all project roles](#api-rest-api-2-role-get) to get a list of project role IDs.
 ...
 * **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
 *
 * @param params.id - The ID of the project role to delete. Use [Get all project roles](#api-rest-api-2-role-get) to get a list of project role IDs.
 * @param params.swap - The ID of the project role that will replace the one being deleted. The swap will attempt to swap the role in schemes (notifications, permissions, issue security), workflows, worklogs and comments.
 * @returns Returned if the request is successful.
 */
...
export function createProjectRolesService(ctx: ClientContext) {
  return {
    /**
     * Get project roles for project
     *
    ...
    getProjectRoles(
      ...
      return getProjectRoles(ctx, params, options);
    },
    ...
    getProjectRole(
      ...
      return getProjectRole(ctx, params, options);
    },
    ...
    getProjectRoleDetails(
      ...
      return getProjectRoleDetails(ctx, params, options);
    },
     ...
     * @returns Returned if the request is successful.
     */
    getAllProjectRoles(options?: {
      headers?: Record<string, string | number | boolean>;
      signal?: AbortSignal;
      extensions?: Record<string, unknown>;
    }): Promise<ProjectRole[]> {
      return getAllProjectRoles(ctx, options);
    },
    ...
    createProjectRole(
      ...
      return createProjectRole(ctx, params, options);
    },
    ...
    getProjectRoleById(
      ...
      return getProjectRoleById(ctx, params, options);
    },
    ...
    fullyUpdateProjectRole(
      ...
      return fullyUpdateProjectRole(ctx, params, options);
    },
    ...
    partialUpdateProjectRole(
      ...
      return partialUpdateProjectRole(ctx, params, options);
    },
    ...
    deleteProjectRole(
      ...
      return deleteProjectRole(ctx, params, options);
    },
  };
}
