...
export default function request<TClient extends ClientType>(
  ...
  return {
    ...
    addRequestParticipants: async ({
      ...
      return jiraRequest<PagedDtoUserDto>({
        ...
        body: JSON.stringify(requestParticipantUpdateDto),
        config,
        opts,
     ...
     * ```
     */
    createCommentWithAttachment: async ({
      issueIdOrKey,
      attachmentCreateDto,
      opts
    }: {
      ...
      return jiraRequest<AttachmentCreateResultDto>({
        path: "/rest/servicedeskapi/request/{issueIdOrKey}/attachment",
        method: "POST",
        pathParams: { issueIdOrKey },
        body: JSON.stringify(attachmentCreateDto),
        config,
        opts,
        isResponseAvailable: true
      });
    ...
    createCustomerRequest: async ({
      ...
      return jiraRequest<CustomerRequestDto>({
        path: "/rest/servicedeskapi/request",
        method: "POST",
        body: JSON.stringify(requestCreateDto),
        config,
        opts,
        isResponseAvailable: true
      });
    ...
    getApprovals: async ({
      ...
      return jiraRequest<PagedDtoApprovalDto>({
     ...
     * ```
     */
    getAttachmentsForRequest: async ({
      issueIdOrKey,
      start,
      limit,
      opts
      ...
      return jiraRequest<PagedDtoAttachmentDto>({
        path: "/rest/servicedeskapi/request/{issueIdOrKey}/attachment",
        method: "GET",
        pathParams: { issueIdOrKey },
        queryParams: { start, limit },
     ...
     * ```
     */
    getCustomerRequestByIdOrKey: async ({
      issueIdOrKey,
      expand,
      opts
    }: {
    ...
    getCustomerRequests: async ({
      ...
      return jiraRequest<PagedDtoCustomerRequestDto>({
        path: "/rest/servicedeskapi/request",
        method: "GET",
        queryParams: {
          searchTerm,
     ...
     * ```
     */
    getCustomerRequestStatus: async ({
      issueIdOrKey,
      start,
      limit,
      opts
      ...
      return jiraRequest<PagedDtoCustomerRequestStatusDto>({
    ...
    getCustomerTransitions: async ({
      ...
      return jiraRequest<PagedDtoCustomerTransitionDto>({
    ...
    getFeedback: async ({
      ...
      return jiraRequest<CsatFeedbackFullDto>({
        path: "/rest/servicedeskapi/request/{requestIdOrKey}/feedback",
        method: "GET",
        pathParams: { requestIdOrKey },
        config,
    ...
    getRequestComments: async ({
      ...
      return jiraRequest<PagedDtoCommentDto>({
        path: "/rest/servicedeskapi/request/{issueIdOrKey}/comment",
        method: "GET",
        pathParams: { issueIdOrKey },
        queryParams: {
    ...
    getSlaInformation: async ({
      ...
      return jiraRequest<PagedDtoSlaInformationDto>({
    ...
    getSlaInformationById: async ({
      ...
      return jiraRequest<SlaInformationDto>({
    ...
    getSubscriptionStatus: async ({
      ...
      return jiraRequest<RequestNotificationSubscriptionDto>({
     ...
     */
    performCustomerTransition: async ({
      issueIdOrKey,
      customerTransitionExecutionDto,
      opts
    }: {
      ...
      return jiraRequest<void>({
        ...
        method: "POST",
        pathParams: { issueIdOrKey },
        body: JSON.stringify(customerTransitionExecutionDto),
        config,
        opts,
        isResponseAvailable: false
      });
    ...
    postFeedback: async ({
      ...
      return jiraRequest<CsatFeedbackFullDto>({
        ...
        method: "POST",
        pathParams: { requestIdOrKey },
        body: JSON.stringify(csatFeedbackFullDto),
        config,
        opts,
        isResponseAvailable: true
      });
     ...
     * ```
     */
    removeRequestParticipants: async ({
      issueIdOrKey,
      requestParticipantUpdateDto,
      opts
    }: {
